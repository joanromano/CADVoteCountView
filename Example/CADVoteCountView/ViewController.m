...
- (void)updateViewConstraints
{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-120-[_countView]-120-[_animateButton]-[_changeBackgroundButton]-[_changeTypeButton]-(>=0)-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_countView, _animateButton, _changeBackgroundButton, _changeTypeButton)]];
